...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		Block: BlockSettings{
			...
			CheckDuplicateTransactionsConcurrency: getInt("block_checkDuplicateTransactionsConcurrency", 32, alternativeContext...),
			GetAndValidateSubtreesConcurrency:     getInt("block_getAndValidateSubtreesConcurrency", 32, alternativeContext...),
			KafkaWorkers:                          getInt("block_kafkaWorkers", 0, alternativeContext...),
			ValidOrderAndBlessedConcurrency:       getInt("block_validOrderAndBlessedConcurrency", 32, alternativeContext...),
