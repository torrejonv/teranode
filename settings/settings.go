...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		UtxoStore: UtxoStoreSettings{
			...
			LockedBatcherSize:              getInt("utxostore_lockedBatcherSize", 256, alternativeContext...),
			LockedBatcherDurationMillis:    getInt("utxostore_lockedBatcherDurationMillis", 10, alternativeContext...),
