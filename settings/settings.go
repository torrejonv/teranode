...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		BlockValidation: BlockValidationSettings{
			...
			ArePreviousBlocksProcessedRetryBackoffMultiplier: getInt("blockvalidation_isParentMined_retry_backoff_multiplier", 30, alternativeContext...), SubtreeGroupConcurrency: getInt("blockvalidation_subtreeGroupConcurrency", 1, alternativeContext...),
