...
services:
  ubsv-builder:
    ...
    build:
      ...
      args:
        BASE_IMG: 434394763103.dkr.ecr.eu-north-1.amazonaws.com/ubsv:base-build-4574035
        RUN_IMG: 434394763103.dkr.ecr.eu-north-1.amazonaws.com/ubsv:base-run-4574035
    networks:
      - ubsv-network
    entrypoint: ["pwd"]
