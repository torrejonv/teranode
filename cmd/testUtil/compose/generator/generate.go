...
services:
  ubsv-builder:
    ...
    build:
      ...
      args:
        BASE_IMG: 434394763103.dkr.ecr.eu-north-1.amazonaws.com/ubsv:base-build-5979f90
        RUN_IMG: 434394763103.dkr.ecr.eu-north-1.amazonaws.com/ubsv:base-run-5979f90
    networks:
      - ubsv-network
    entrypoint: ["pwd"]
