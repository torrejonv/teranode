...
require (
	...
	github.com/apple/foundationdb/bindings/go v0.0.0-20230404213121-c5b8908828d7
...
require (
	...
	github.com/opentracing-contrib/echo v0.0.0-20190807091611-5fe2e1308f06 // indirect
