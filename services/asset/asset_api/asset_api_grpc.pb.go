...
func (c *assetAPIClient) GetFullBlock(ctx context.Context, in *GetBlockRequest, opts ...grpc.CallOption) (*GetFullBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssetAPI_GetFullBlock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetAPIClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Notification], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AssetAPI_SubscribeClient = grpc.ServerStreamingClient[Notification]
...
// UnimplementedAssetAPIServer must be embedded to have
...
func (UnimplementedAssetAPIServer) Subscribe(*SubscribeRequest, grpc.ServerStreamingServer[Notification]) error {
	return status.Errorf(codes.Unimplemented, "method Subscribe not implemented")
}
func (UnimplementedAssetAPIServer) mustEmbedUnimplementedAssetAPIServer() {}
func (UnimplementedAssetAPIServer) testEmbeddedByValue()                  {}
...
func RegisterAssetAPIServer(s grpc.ServiceRegistrar, srv AssetAPIServer) {
	// If the following call pancis, it indicates UnimplementedAssetAPIServer was
...
func _AssetAPI_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AssetAPIServer).Subscribe(m, &grpc.GenericServerStream[SubscribeRequest, Notification]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AssetAPI_SubscribeServer = grpc.ServerStreamingServer[Notification]
