...
import (
	...
	blockchain_store "github.com/bitcoin-sv/teranode/stores/blockchain/sql"
...
func TestGetBlockHeadersFromCommonAncestor_Integration(t *testing.T) {
	...
	repo, err := repository.NewRepository(logger, tSettings, nil, nil, blockchainClient, nil, nil)
	require.NoError(t, err)
