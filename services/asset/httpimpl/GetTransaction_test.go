...
func TestGetTransaction(t *testing.T) {
	...
	t.Run("JSON with invalid tx bytes", func(t *testing.T) {
		...
		assert.Equal(t, "Error: PROCESSING (error code: 4), Message: error parsing transaction, Wrapped err: Error: UNKNOWN (error code: 0), Message: nLockTime length must be 4 bytes long", echoErr.Message)
	})
	...
	t.Run("Repository error", func(t *testing.T) {
		...
		// Check response body
		assert.Equal(t, "Error: PROCESSING (error code: 4), Message: error getting transaction", echoErr.Message)
	})
	...
	t.Run("Repository not found", func(t *testing.T) {
		...
		// Check response body
		assert.Equal(t, "Error: NOT_FOUND (error code: 3), Message: transaction not found", echoErr.Message)
	})
