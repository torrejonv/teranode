...
func (c *validatorAPIClient) HealthGRPC(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, ValidatorAPI_HealthGRPC_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *validatorAPIClient) ValidateTransactionStream(ctx context.Context, opts ...grpc.CallOption) (ValidatorAPI_ValidateTransactionStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ValidatorAPI_ServiceDesc.Streams[0], ValidatorAPI_ValidateTransactionStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
