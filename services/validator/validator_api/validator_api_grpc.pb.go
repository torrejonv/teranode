...
func (c *validatorAPIClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/validator_api.ValidatorAPI/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *validatorAPIClient) ValidateTransactionStream(ctx context.Context, opts ...grpc.CallOption) (ValidatorAPI_ValidateTransactionStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ValidatorAPI_ServiceDesc.Streams[0], "/validator_api.ValidatorAPI/ValidateTransactionStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &validatorAPIValidateTransactionStreamClient{stream}
	return x, nil
}
...
func _ValidatorAPI_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/validator_api.ValidatorAPI/Health",
	}
...
func _ValidatorAPI_ValidateTransactionStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ValidatorAPIServer).ValidateTransactionStream(&validatorAPIValidateTransactionStreamServer{stream})
}
