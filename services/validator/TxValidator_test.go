...
func Test_isConsolidationTx(t *testing.T) {
	...
	assert.False(t, txValidator.isConsolidationTx(parentTx1))
	...
	assert.False(t, txValidator.isConsolidationTx(parentTx2))
	...
	assert.True(t, txValidator.isConsolidationTx(consolidationTx))
}
