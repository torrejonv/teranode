...
// Validator type carries the logger within it
...
func NewServer(logger utils.Logger) *Validator {
	return &Validator{
		logger: logger,
	}
}
...
func (v *Validator) ValidateTransaction(stream validator_api.ValidatorAPI_ValidateTransactionServer) error {
...
func (v *Validator) logError(err error) error {
	if err != nil {
