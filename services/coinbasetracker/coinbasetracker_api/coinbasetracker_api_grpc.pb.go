...
const (
	...
	CoinbasetrackerAPI_MarkUtxoSpent_FullMethodName = "/coinbasetracker_api.CoinbasetrackerAPI/MarkUtxoSpent"
)
...
func (c *coinbasetrackerAPIClient) MarkUtxoSpent(ctx context.Context, in *MarkUtxoSpentRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, CoinbasetrackerAPI_MarkUtxoSpent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCoinbasetrackerAPIServer) MarkUtxoSpent(context.Context, *MarkUtxoSpentRequest) (*emptypb.Empty, error) {
...
func _CoinbasetrackerAPI_MarkUtxoSpent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkUtxoSpentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoinbasetrackerAPIServer).MarkUtxoSpent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CoinbasetrackerAPI_MarkUtxoSpent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoinbasetrackerAPIServer).MarkUtxoSpent(ctx, req.(*MarkUtxoSpentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CoinbasetrackerAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CoinbasetrackerAPI_MarkUtxoSpent_Handler,
		},
	},
