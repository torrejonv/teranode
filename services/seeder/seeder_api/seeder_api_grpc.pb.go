...
const (
	SeederAPI_HealthGRPC_FullMethodName                   = "/seeder_api.SeederAPI/HealthGRPC"
...
func (c *seederAPIClient) HealthGRPC(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, SeederAPI_HealthGRPC_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSeederAPIServer) HealthGRPC(context.Context, *emptypb.Empty) (*HealthResponse, error) {
...
func _SeederAPI_HealthGRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SeederAPIServer).HealthGRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SeederAPI_HealthGRPC_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeederAPIServer).HealthGRPC(ctx, req.(*emptypb.Empty))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SeederAPI_HealthGRPC_Handler,
		},
		{
