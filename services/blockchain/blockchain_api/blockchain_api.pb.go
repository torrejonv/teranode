...
// FSMEventType defines possible events in the blockchain FSM.
type FSMEventType int32

const (
	FSMEventType_STOP          FSMEventType = 0 // Stop the blockchain service
	FSMEventType_RUN           FSMEventType = 1 // Start normal operation
	FSMEventType_CATCHUPBLOCKS FSMEventType = 2 // Start catching up missing blocks
	FSMEventType_LEGACYSYNC    FSMEventType = 3 // Start legacy sync mode
)
