...
var file_services_blockchain_blockchain_api_blockchain_api_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x44, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x42,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x53, 0x0a, 0x12, 0x47, 0x65, 0x74,
	0x46, 0x53, 0x4d, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x23, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63,
...
var file_services_blockchain_blockchain_api_blockchain_api_proto_goTypes = []any{
	...
	(*GetBlockLocatorRequest)(nil),            // 42: blockchain_api.GetBlockLocatorRequest
	(*GetBlockLocatorResponse)(nil),           // 43: blockchain_api.GetBlockLocatorResponse
	(*LocateBlockHeadersRequest)(nil),         // 44: blockchain_api.LocateBlockHeadersRequest
	(*LocateBlockHeadersResponse)(nil),        // 45: blockchain_api.LocateBlockHeadersResponse
	(*GetBestHeightAndTimeResponse)(nil),      // 46: blockchain_api.GetBestHeightAndTimeResponse
...
var file_services_blockchain_blockchain_api_blockchain_api_proto_depIdxs = []int32{
	...
	52, // 7: blockchain_api.BlockchainAPI.HealthGRPC:input_type -> google.protobuf.Empty
	3,  // 8: blockchain_api.BlockchainAPI.AddBlock:input_type -> blockchain_api.AddBlockRequest
	4,  // 9: blockchain_api.BlockchainAPI.GetBlock:input_type -> blockchain_api.GetBlockRequest
	5,  // 10: blockchain_api.BlockchainAPI.GetBlocks:input_type -> blockchain_api.GetBlocksRequest
	7,  // 11: blockchain_api.BlockchainAPI.GetBlockByHeight:input_type -> blockchain_api.GetBlockByHeightRequest
	52, // 12: blockchain_api.BlockchainAPI.GetBlockStats:input_type -> google.protobuf.Empty
	10, // 13: blockchain_api.BlockchainAPI.GetBlockGraphData:input_type -> blockchain_api.GetBlockGraphDataRequest
	29, // 14: blockchain_api.BlockchainAPI.GetLastNBlocks:input_type -> blockchain_api.GetLastNBlocksRequest
	31, // 15: blockchain_api.BlockchainAPI.GetSuitableBlock:input_type -> blockchain_api.GetSuitableBlockRequest
	33, // 16: blockchain_api.BlockchainAPI.GetHashOfAncestorBlock:input_type -> blockchain_api.GetHashOfAncestorBlockRequest
	35, // 17: blockchain_api.BlockchainAPI.GetNextWorkRequired:input_type -> blockchain_api.GetNextWorkRequiredRequest
	4,  // 18: blockchain_api.BlockchainAPI.GetBlockExists:input_type -> blockchain_api.GetBlockRequest
	13, // 19: blockchain_api.BlockchainAPI.GetBlockHeaders:input_type -> blockchain_api.GetBlockHeadersRequest
	15, // 20: blockchain_api.BlockchainAPI.GetBlockHeadersFromHeight:input_type -> blockchain_api.GetBlockHeadersFromHeightRequest
	13, // 21: blockchain_api.BlockchainAPI.GetBlockHeaderIDs:input_type -> blockchain_api.GetBlockHeadersRequest
	52, // 22: blockchain_api.BlockchainAPI.GetBestBlockHeader:input_type -> google.protobuf.Empty
	19, // 23: blockchain_api.BlockchainAPI.GetBlockHeader:input_type -> blockchain_api.GetBlockHeaderRequest
	20, // 24: blockchain_api.BlockchainAPI.InvalidateBlock:input_type -> blockchain_api.InvalidateBlockRequest
	21, // 25: blockchain_api.BlockchainAPI.RevalidateBlock:input_type -> blockchain_api.RevalidateBlockRequest
	23, // 26: blockchain_api.BlockchainAPI.Subscribe:input_type -> blockchain_api.SubscribeRequest
	24, // 27: blockchain_api.BlockchainAPI.SendNotification:input_type -> blockchain_api.Notification
	26, // 28: blockchain_api.BlockchainAPI.GetState:input_type -> blockchain_api.GetStateRequest
	28, // 29: blockchain_api.BlockchainAPI.SetState:input_type -> blockchain_api.SetStateRequest
	37, // 30: blockchain_api.BlockchainAPI.SetBlockMinedSet:input_type -> blockchain_api.SetBlockMinedSetRequest
	52, // 31: blockchain_api.BlockchainAPI.GetBlocksMinedNotSet:input_type -> google.protobuf.Empty
	39, // 32: blockchain_api.BlockchainAPI.SetBlockSubtreesSet:input_type -> blockchain_api.SetBlockSubtreesSetRequest
	52, // 33: blockchain_api.BlockchainAPI.GetBlocksSubtreesNotSet:input_type -> google.protobuf.Empty
	52, // 34: blockchain_api.BlockchainAPI.GetFSMCurrentState:input_type -> google.protobuf.Empty
	42, // 35: blockchain_api.BlockchainAPI.GetBlockLocator:input_type -> blockchain_api.GetBlockLocatorRequest
	44, // 36: blockchain_api.BlockchainAPI.LocateBlockHeaders:input_type -> blockchain_api.LocateBlockHeadersRequest
	52, // 37: blockchain_api.BlockchainAPI.GetBestHeightAndTime:input_type -> google.protobuf.Empty
	2,  // 38: blockchain_api.BlockchainAPI.HealthGRPC:output_type -> blockchain_api.HealthResponse
	52, // 39: blockchain_api.BlockchainAPI.AddBlock:output_type -> google.protobuf.Empty
	8,  // 40: blockchain_api.BlockchainAPI.GetBlock:output_type -> blockchain_api.GetBlockResponse
	6,  // 41: blockchain_api.BlockchainAPI.GetBlocks:output_type -> blockchain_api.GetBlocksResponse
	8,  // 42: blockchain_api.BlockchainAPI.GetBlockByHeight:output_type -> blockchain_api.GetBlockResponse
	53, // 43: blockchain_api.BlockchainAPI.GetBlockStats:output_type -> model.BlockStats
	54, // 44: blockchain_api.BlockchainAPI.GetBlockGraphData:output_type -> model.BlockDataPoints
	30, // 45: blockchain_api.BlockchainAPI.GetLastNBlocks:output_type -> blockchain_api.GetLastNBlocksResponse
	32, // 46: blockchain_api.BlockchainAPI.GetSuitableBlock:output_type -> blockchain_api.GetSuitableBlockResponse
	34, // 47: blockchain_api.BlockchainAPI.GetHashOfAncestorBlock:output_type -> blockchain_api.GetHashOfAncestorBlockResponse
	36, // 48: blockchain_api.BlockchainAPI.GetNextWorkRequired:output_type -> blockchain_api.GetNextWorkRequiredResponse
	11, // 49: blockchain_api.BlockchainAPI.GetBlockExists:output_type -> blockchain_api.GetBlockExistsResponse
	14, // 50: blockchain_api.BlockchainAPI.GetBlockHeaders:output_type -> blockchain_api.GetBlockHeadersResponse
	16, // 51: blockchain_api.BlockchainAPI.GetBlockHeadersFromHeight:output_type -> blockchain_api.GetBlockHeadersFromHeightResponse
	17, // 52: blockchain_api.BlockchainAPI.GetBlockHeaderIDs:output_type -> blockchain_api.GetBlockHeaderIDsResponse
	22, // 53: blockchain_api.BlockchainAPI.GetBestBlockHeader:output_type -> blockchain_api.GetBlockHeaderResponse
	22, // 54: blockchain_api.BlockchainAPI.GetBlockHeader:output_type -> blockchain_api.GetBlockHeaderResponse
	52, // 55: blockchain_api.BlockchainAPI.InvalidateBlock:output_type -> google.protobuf.Empty
	52, // 56: blockchain_api.BlockchainAPI.RevalidateBlock:output_type -> google.protobuf.Empty
	24, // 57: blockchain_api.BlockchainAPI.Subscribe:output_type -> blockchain_api.Notification
	52, // 58: blockchain_api.BlockchainAPI.SendNotification:output_type -> google.protobuf.Empty
	27, // 59: blockchain_api.BlockchainAPI.GetState:output_type -> blockchain_api.StateResponse
	52, // 60: blockchain_api.BlockchainAPI.SetState:output_type -> google.protobuf.Empty
	52, // 61: blockchain_api.BlockchainAPI.SetBlockMinedSet:output_type -> google.protobuf.Empty
	38, // 62: blockchain_api.BlockchainAPI.GetBlocksMinedNotSet:output_type -> blockchain_api.GetBlocksMinedNotSetResponse
	52, // 63: blockchain_api.BlockchainAPI.SetBlockSubtreesSet:output_type -> google.protobuf.Empty
	40, // 64: blockchain_api.BlockchainAPI.GetBlocksSubtreesNotSet:output_type -> blockchain_api.GetBlocksSubtreesNotSetResponse
	41, // 65: blockchain_api.BlockchainAPI.GetFSMCurrentState:output_type -> blockchain_api.GetFSMStateResponse
	43, // 66: blockchain_api.BlockchainAPI.GetBlockLocator:output_type -> blockchain_api.GetBlockLocatorResponse
	45, // 67: blockchain_api.BlockchainAPI.LocateBlockHeaders:output_type -> blockchain_api.LocateBlockHeadersResponse
	46, // 68: blockchain_api.BlockchainAPI.GetBestHeightAndTime:output_type -> blockchain_api.GetBestHeightAndTimeResponse
