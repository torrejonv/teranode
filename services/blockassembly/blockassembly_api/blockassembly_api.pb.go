...
func (x *AddTxIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddTxIDRequest) ProtoMessage() {}

func (x *AddTxIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_services_blockassembly_blockassembly_api_blockassembly_api_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddTxIDRequest.ProtoReflect.Descriptor instead.
func (*AddTxIDRequest) Descriptor() ([]byte, []int) {
	return file_services_blockassembly_blockassembly_api_blockassembly_api_proto_rawDescGZIP(), []int{1}
}

func (x *AddTxIDRequest) GetTxid() []byte {
	if x != nil {
		return x.Txid
	}
	return nil
...
func (x *AddTxIDResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddTxIDResponse) ProtoMessage() {}

func (x *AddTxIDResponse) ProtoReflect() protoreflect.Message {
	mi := &file_services_blockassembly_blockassembly_api_blockassembly_api_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddTxIDResponse.ProtoReflect.Descriptor instead.
func (*AddTxIDResponse) Descriptor() ([]byte, []int) {
	return file_services_blockassembly_blockassembly_api_blockassembly_api_proto_rawDescGZIP(), []int{2}
}

func (x *AddTxIDResponse) GetOk() bool {
	if x != nil {
		return x.Ok
	}
	return false
...
var file_services_blockassembly_blockassembly_api_blockassembly_api_proto_rawDesc = []byte{
	...
	,
	...
	0x0a, 0x07, 0x41, 0x64, 0x64, 0x54, 0x78, 0x49, 0x44, 0x12, 0x21, 0x2e, 0x62, 0x6c, 0x6f, 0x63,
	0x6b, 0x61, 0x73, 0x73, 0x65, 0x6d, 0x62, 0x6c, 0x79, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x64,
	0x64, 0x54, 0x78, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x61, 0x73, 0x73, 0x65, 0x6d, 0x62, 0x6c, 0x79, 0x5f, 0x61, 0x70, 0x69,
	0x2e, 0x41, 0x64, 0x64, 0x54, 0x78, 0x49, 0x44, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
...
var file_services_blockassembly_blockassembly_api_blockassembly_api_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_services_blockassembly_blockassembly_api_blockassembly_api_proto_goTypes = []interface{}{
	...
	(*AddTxIDRequest)(nil),        // 1: blockassembly_api.AddTxIDRequest
	(*AddTxIDResponse)(nil),       // 2: blockassembly_api.AddTxIDResponse
	(*timestamppb.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 4: google.protobuf.Empty
}
var file_services_blockassembly_blockassembly_api_blockassembly_api_proto_depIdxs = []int32{
	3, // 0: blockassembly_api.HealthResponse.timestamp:type_name -> google.protobuf.Timestamp
	4, // 1: blockassembly_api.BlockAssemblyAPI.Health:input_type -> google.protobuf.Empty
	1, // 2: blockassembly_api.BlockAssemblyAPI.AddTxID:input_type -> blockassembly_api.AddTxIDRequest
	0, // 3: blockassembly_api.BlockAssemblyAPI.Health:output_type -> blockassembly_api.HealthResponse
	2, // 4: blockassembly_api.BlockAssemblyAPI.AddTxID:output_type -> blockassembly_api.AddTxIDResponse
