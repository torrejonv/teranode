...
func file_services_p2p_p2p_api_p2p_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_p2p_p2p_api_p2p_api_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Peer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_services_p2p_p2p_api_p2p_api_proto_msgTypes[1].Exporter = func(v any, i int) any {
