...
func (c *propagationAPIClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/propagation_api.PropagationAPI/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *propagationAPIClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/propagation_api.PropagationAPI/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *propagationAPIClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/propagation_api.PropagationAPI/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PropagationAPI_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/propagation_api.PropagationAPI/Health",
	}
...
func _PropagationAPI_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/propagation_api.PropagationAPI/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PropagationAPI_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/propagation_api.PropagationAPI/Set",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
