...
func (rr *RedisCluster) UnSpend(ctx context.Context, spends []*utxostore.Spend) (err error) {
	for _, spend := range spends {
...
func (rr *RedisCluster) unSpend(ctx context.Context, spend *utxostore.Spend) error {
