...
func TestFile_Get(t *testing.T) {
	t.Run("test", func(t *testing.T) {
		f, err := New(ulogger.TestLogger{}, "/tmp/ubsv-tests", "persist")
...
func TestFile_filename(t *testing.T) {
	...
	t.Run("1 paths", func(t *testing.T) {
		f, err := New(ulogger.TestLogger{}, "/tmp/ubsv-tests", "persist", []string{"/tmp/ubsv-tests1"})
		require.NoError(t, err)
	...
	t.Run("2 paths", func(t *testing.T) {
		f, err := New(ulogger.TestLogger{}, "/tmp/ubsv-tests", "persist", []string{"/tmp/ubsv-tests1", "/tmp/ubsv-tests2"})
		require.NoError(t, err)
	...
	t.Run("4 paths", func(t *testing.T) {
		f, err := New(ulogger.TestLogger{}, "/tmp/ubsv-tests", "persist", []string{
			"/tmp/ubsv-tests1",
			"/tmp/ubsv-tests2",
			"/tmp/ubsv-tests3",
			"/tmp/ubsv-tests4",
