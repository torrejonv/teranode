...
1. [DEPRECATED: Kept for historical purposes only](#deprecated-kept-for-historical-purposes-only)
2. [Description](#1-description)
   - [2.1 Purpose](#11-purpose)
3. [Architecture](#2-architecture)
4. [Data Model](#3-data-model)
5. [Use Cases](#4-use-cases)
   - [5.1. Asset Server](#41-asset-server)
   - [5.2. Transaction Validation Service](#42-transaction-validation-service)
   - [5.3. Block Validation Service](#43-block-validation-service)
      - [5.3.1. Block Validation: TX Meta Cache](#431-block-validation-tx-meta-cache)
      - [5.3.2. Block Validation: Validate Subtrees](#432-block-validation-validate-subtrees)
      - [5.3.3. Block Validation: Store Coinbase TX Meta Data](#433-block-validation-store-coinbase-tx-meta-data)
      - [5.3.4. Block Validation: Update TX Meta as Mined](#434-block-validation-update-tx-meta-as-mined)
   - [5.4. Block Assembly Service](#44-block-assembly-service)
6. [Technology](#5-technology)
   - [6.1. Language and Libraries](#51-language-and-libraries)
   - [6.2. Data Stores](#52-data-stores)
   - [6.3. Data Purging](#53-data-purging)
7. [Directory Structure and Main Files](#6-directory-structure-and-main-files)
8. [How to run](#7-how-to-run)
   - [8.1. Running TxMeta](#71-running-txmeta)
   - [8.2. Configuration options (settings flags)](#72-configuration-options-settings-flags)
      - [8.2.1. Timeout Settings](#timeout-settings)
      - [8.2.2. Time-to-Live (TTL) Settings](#time-to-live-ttl-settings)
      - [8.2.3. Batch Processing Settings](#batch-processing-settings)
      - [8.2.4. Block Validation: TX Meta Cache Settings](#block-validation-tx-meta-cache-settings)
      - [8.2.5. Data Store Examples](#data-store-examples)
