...
docker run -it \
    ...
    --entrypoint="" \
  ghcr.io/bsv-blockchain/teranode:v0.9.22 \
...
```bash
# bring up any dependent services if you aren't running them remotely
docker compose up -d aerospike aerospike-2 postgres kafka-shared

# make sure none of the Teranode services are running
...
To do so, you can use the `/app/teranode-cli seeder` described in the previous section.
...
- [How to Install Teranode - Docker](docker/minersHowToInstallation.md)
- [How to Install Teranode - Kubernetes](kubernetes/minersHowToInstallation.md)
- [How to Configure Teranode - Docker](docker/minersHowToConfigureTheNode.md)
- [How to Configure Teranode - Kubernetes](kubernetes/minersHowToConfigureTheNode.md)
