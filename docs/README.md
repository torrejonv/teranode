...
- [7.1. Go](#71-go)
- [7.2. gRPC](#72-grpc)
- [7.3. Protobuf](#73-protobuf)
- [7.4. IPv6 Multicast](#74-ipv6-multicast)
- [7.5. Stores](#75-stores)
...
The Makefile facilitates a variety of development and build tasks for the Teranode project.
